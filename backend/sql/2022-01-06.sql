...
CREATE TABLE `redis_info`  (
  ...
  `name` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'redis信息名称',
  ...
  `create_time` datetime(0) NOT NULL DEFAULT '1900-01-01 00:00:00',
...
-- ----------------------------
INSERT INTO `redis_info` VALUES (1, '本机1', 'localhost', 6379, '', '123456', 'STANDALONE', '1900-01-01 00:00:00', -5, '2022-01-06 00:00:00', -5);
...
CREATE TABLE `user1`  (
  ...
  `create_date` datetime(0) NOT NULL DEFAULT '1900-01-01 00:00:00',
  PRIMARY KEY (`id`) USING BTREE
...
-- Records of user1
-- ----------------------------
INSERT INTO `user1` VALUES (1, 'name1', '1900-01-03 00:00:00');
