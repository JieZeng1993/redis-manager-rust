...
import {loginNew} from '@/services/ant-design-pro/userApi';
...
const Login: React.FC = () => {
    const [userLoginState, setUserLoginState] = useState<USER_API.LoginResult>({});
    ...
    const handleSubmit = async (values: USER_API.LoginParams) => {
        try {
            // 登录
        ...
        <div className={styles.container}>
            ...
            <div className={styles.content}>
                ...
                >
                    ...
                    {loginType === 'mobile' && <LoginMessage content="验证码错误"/>}
                    {type === 'mobile' && (
                        <>
                            <ProFormText
                                fieldProps={{
